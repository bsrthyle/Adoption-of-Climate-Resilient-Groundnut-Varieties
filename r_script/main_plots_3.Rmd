...
df_tbl_1 <- df_plot%>%
  filter(tbl_no==6)%>%
  mutate(dep_var=factor(dep_var, levels = c("Yield","Production", "Production value")))
  ...
  ggsave("plots/plt1_new.png", plt_tbl_1, width = 30, height = 16, units = "cm")
```
...
ggsave("plots/plt2.png", plt_tbl_4, width = 24, height = 16, units = "cm")
...
ggsave("plots/plt3.png", plt_7, width = 24, height = 12, units = "cm")
...
df_tbl_9 <- df_plot%>%
  ...
  plt_tbl_9
   ggsave("plots/plt4_new.png", plt_tbl_9, width = 25, height = 13, units = "cm")
```
```{r}
...
df_tbl_8 <- df_plot%>%
  ...
  plt_tbl_8
   ggsave("plots/plt8_new.svg", plt_tbl_8, width = 35, height = 16, units = "cm")
```