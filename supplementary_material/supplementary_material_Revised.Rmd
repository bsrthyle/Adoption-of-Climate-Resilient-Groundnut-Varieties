...
kableExtra::kbl(df, longtable = T, booktabs = T, escape=F, align="lrrr", linesep ="", caption = "Full OLS estimates of the relationship between adoption and commercialization(Adoption)")%>%
...
kableExtra::kbl(df, longtable = T, booktabs = T, escape=F, align="lrrr", linesep ="" ,caption = "Full OLS estimates of the relationship between adoption and commercialization (Area under Adoption)")%>%
kable_styling(font_size = 7, latex_options = c("repeat_header"))
```
...
kableExtra::kbl(df, longtable = T, booktabs = T, escape=F, align="lrrr", linesep ="" , caption = " Full OLS estimates of the relationship between adoption, production and yields(Adoption)")%>%
kable_styling(font_size = 7, latex_options = c("repeat_header"))
```
...
kableExtra::kbl(df, longtable = T, booktabs = T, escape=F, align="lrrr", linesep ="" , caption = "OLS estimates of the relationship between adoption, production and yields(Area under Adoption)")%>%
kable_styling(font_size = 7, latex_options = c("repeat_header"))%>%
...
kableExtra::kbl(df, longtable = T, booktabs = T, escape=F, align="lrrr", linesep ="" ,caption = "Full 2SLS estimates of the relationship between adoption and commercialization(Adoption)")%>%
kable_styling(font_size = 7, latex_options = c("repeat_header"))
```
\newpage
...
kableExtra::kbl(df, longtable = T, booktabs = T, escape=F, align="lrrr", linesep ="", caption = "Full 2SLS estimates of the relationship between adoption and commercialization")%>%
kable_styling(font_size = 7, latex_options = c("repeat_header"))
```
...
kableExtra::kbl(df, longtable = T, booktabs = T, escape=F, align="lrrr", linesep ="" ,caption = "Full 2SLS estimates of the relationship between adoption (Area), production and yields")%>%
kable_styling(font_size = 7, latex_options = c("repeat_header"))%>%
landscape()
```
\newpage
...
kableExtra::kbl(df, longtable = T, booktabs = T, escape=F, align="lrrr", linesep ="", caption = "Full 2SLS estimates of the relationship between adoption, production and yields")%>%
kable_styling(font_size = 7, latex_options = c("repeat_header"))%>%
landscape()
```
...
kableExtra::kbl(df, longtable = T, booktabs = T, escape=F, align="lrrr", linesep ="", caption = " Full 2SLS estimates of the relationship between continous adoption,production and yields")%>%
kable_styling(font_size = 7, latex_options = c("repeat_header"))%>%
landscape()
```
\newpage
...
kableExtra::kbl(df, longtable = T, booktabs = T, escape=F, align="lrrr", linesep ="" ,caption = "Full Correlated random effects estimations of the relationship between adoption , commercialization and market orientation")%>%
kable_styling(font_size = 7, latex_options = c("repeat_header"))%>%
  landscape()
```
...
kableExtra::kbl(df, longtable = T, booktabs = T, escape=F, align="lrrr", linesep ="", caption = "Full Correlated random effects estimations of the relationship between adoption (area), commercialization and market orientation")%>%
kable_styling(font_size = 7, latex_options = c("repeat_header"))%>%
  landscape()
```
\newpage
...
kableExtra::kbl(df, longtable = T, booktabs = T, escape=F, align="lrrr", linesep ="", caption = "Linear IV mediation analysis of adoption and commercialization (production)")%>%
kable_styling(font_size = 7, latex_options = c("repeat_header"))
```
...
kableExtra::kbl(df, longtable = T, booktabs = T, escape=F, align="lrrr", linesep ="", caption = "Linear IV mediation analysis of adoption and commercialization (Yield)")%>%
kable_styling(font_size = 7, latex_options = c("repeat_header"))
```
\newpage
...
kableExtra::kbl(df, longtable = T, booktabs = T, escape=F,col.names = c("variables", "Yield", "Commercialization", "Yield", "Commercialization", "Yield", "Commercialization"), align="lrrr", linesep ="" ,caption = "2SLS estimates of the relationship between adoption and commercialization and yield across countries")%>%
kable_styling(font_size = 7, latex_options = c("repeat_header"))%>%
  landscape()%>%
...
kableExtra::kbl(df, longtable = T, booktabs = T, escape=F, align="lrrr", linesep ="" ,caption = "Full Control function estimations of the relationship between adoption and market participation")%>%
kable_styling(font_size = 7, latex_options = c("repeat_header"))%>%
  landscape()
```
\newpage
...
kableExtra::kbl(df, longtable = T, booktabs = T, escape=F, align="lrrr", linesep ="" ,caption = "Full HAUSMAN TAYLOR IV estimations")%>%
kable_styling(font_size = 7, latex_options = c("repeat_header"))
```
\newpage
## Lewbels Test
...
kableExtra::kbl(df, longtable = T, booktabs = T, escape=F, align="lrrr", linesep ="", caption = "Full Lewbel instrumental variable estimations of the relationship between adoption and commercialization")%>%
kable_styling(font_size = 7, latex_options = c("repeat_header"))
```
